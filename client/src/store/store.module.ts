...
export class StoreModule {
  constructor(public store: NgRedux<IAppState>,
    ...
    const middleware = [
      ...
      createEpicMiddleware(this.epics.createDataServiceEpic(LOAD_HOME_PAGE_TEXT, HOME_PAGE_TEXT_LOADED, 'GetData')),
      createEpicMiddleware(this.epics.createDataServiceEpic(LOAD_CVs, CVs_LOADED, 'GetData')),
      createEpicMiddleware(this.epics.createDataServiceEpic(LOAD_IMGs, IMGs_LOADED, 'GetData')),
      createEpicMiddleware(this.epics.createDataServiceEpic(LOAD_PRGs, PRGs_LOADED, 'GetData')),
      createEpicMiddleware(this.epics.createDataServiceEpic(LOAD_LNKs, LNKs_LOADED, 'GetData')),
