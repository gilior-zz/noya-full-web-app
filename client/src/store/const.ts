...
export const API_HOME_CARDS = API_HOME + '/cards';
export const API_HOME_TEXT = API_HOME + '/text';
export const API_CV = API + 'cv';
export const API_PROGRAMS = API + 'programs';
export const API_LINKS = API + 'links';
export const API_CONTACT = API + 'contact/send';
export const API_GALLERY = API + 'gallery';
